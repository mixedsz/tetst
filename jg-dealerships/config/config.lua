...
Config.DealershipLocations = {
  ["pdm"] = {
    ...
    openShowroom = {
      coords = vec3(-31.4, -1089.08, 26.54),
      size = 5
    },
    openManagement = {
      coords = vec3(-38.97, -1082.42, 25.65),
      size = 5
    },
    sellVehicle = {
      coords = vec3(-51.83, -1096.89, 25.48),
      size = 5
    },
    purchaseSpawn = vec3(-20.52, -1112.11, 25.67),
    testDriveSpawn = vec4(-49.43, -1109.42, 25.44, 68.66),
    camera = {
      name = "Car",
      coords = vector4(-146.6166, -596.6301, 166.0, 270.0),
      positions = {5.0, 8.0, 12.0, 8.0}
    },
    categories = {"sedans", "compacts", "motorcycles", "offroad", "coupes", "muscle", "suvs", "sportsclassics", "ADDON"},
